...
This script sets up a cron job to run the plants_data_collector.py script.
...
def setup_cron_job(full_day=False):
    """
    Set up a cron job to run plants_data_collector.py every 5 minutes
    ...
    # Remove any existing plant collector jobs
    if old_cron_lines:
